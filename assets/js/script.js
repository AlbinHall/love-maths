...
/**
 * Gets the current score from the DOM and adding 1
 */
...
/**
 * Gets the current incorrect score from the DOM and substracting 1
 */
...
function displayDivisionQuestion(operand1, operand2) {
    ...
    document.getElementById("operand1").textContent = operand1 > operand2 ? operand1*operand2 : operand2;
